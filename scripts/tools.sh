...
case "$1" in
    ...
    *)
        ...
        echo ""
        echo "  Wiki 上传相关:"
        echo "    API_KEY        - API Key (默认: ragflow-HeewVgbFXZ1xiebiiHEzhxmZAQb-kOLXBa5WxEVe0JU)"
        echo "    HOST           - 服务器地址 (默认: http://6.13.51.232:9385)"
        echo "    WIKI_DATA_DIR       - 数据目录 (默认: /data/keyang.lk/data/bailing/wiki_zh_20250901_json)"
