    ...
    try:
        ...
        logging.info(
            "Indexing doc({}), page({}-{}), chunks({}), elapsed: {:.2f}".format(
                task_document_name, task_from_page, task_to_page, len(chunks), stage_timings[TaskStage.INSERT_INDEX]
            )
        )
...
/___/_/ /_/\__, /\___/____/\__/_/\____/_/ /_/  /____/\___/_/    |___/\___/_/
    ...
    report_statistics_task = asyncio.create_task(report_task_statistics())
    tasks = []
    try:
        ...
        await asyncio.gather(*tasks, return_exceptions=True)
        report_task.cancel()
        report_statistics_task.cancel()
        await asyncio.gather(report_task, report_statistics_task, return_exceptions=True)
